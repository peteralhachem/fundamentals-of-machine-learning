...
def leave_one_out_cross_validation(classifiers, data_matrix, labels):
    ...
    for classifier in classifiers:
        ...
        classifier_error.append(error)

    return np.array(classifier_error)
...
def plot_density(data_matrix, marginal_log_density):
    ...
    :param data_matrix: data matrix used in the creation of the GMM components.
    :param marginal_log_density: Marginal log density shape (N,)
